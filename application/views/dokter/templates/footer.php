...
<footer class="main-footer">
    ...
    <strong>Akbar Ilham Ardin</strong> All rights
    reserved.
</footer>
...
<script>
    $(document).ready(function() {
        ...
        $('#obat').on('change', function() {
            ...
            var idValue = idArray.join(',');
            $('#id_obat').val(idValue);
            
            var textValue = textArray.join(', ');
            $('#nama_obat').val(textValue);
            ...
            if (selectedValues) {
                for (var i = 0; i < selectedValues.length; i++) {
                    totalBiaya += parseInt(selectedValues[i]);
                }
            }
            
            $('#total').text('Total Biaya : Rp. ' + totalBiaya);
            $('#totalnya').val(totalBiaya);
        });
    });
</script>
